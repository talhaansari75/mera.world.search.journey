...
//#region node_modules/.nitro/vite/services/ssr/assets/router-DNh5UQBb.js
var router_DNh5UQBb_exports = /* @__PURE__ */ __exportAll({ getRouter: () => getRouter });
...
var styles_default = "/assets/styles-C5QQeS0m.css";
var APP_NAME = "Lexora";
var Route$1 = createRootRoute({
	head: () => ({
		meta: [
			...
			{
				name: "description",
				content: "Find the words. Keep the journey."
			}
		],
		links: [
			{
...
var $$splitComponentImporter = () => import("./routes-B13p22L_.mjs");
...
//#endregion
export { getRouter, router_DNh5UQBb_exports as t };
