...
async function getStartManifest(matchedRoutes) {
	const { tsrStartManifest } = await import("../_tanstack-start-manifest_v-o22NKoD1.mjs");
...
var manifest = { "4f33485af221c800dab2859ff779546149dfbecb82236976d5c5bad3665da07b": {
	functionName: "forgeWords_createServerFn_handler",
	importer: () => import("./forge-CgqMJICj.mjs")
} };
...
async function loadEntries() {
	const [routerEntry, startEntry, pluginAdapters] = await Promise.all([
		import("./router-DNh5UQBb.mjs").then((n) => n.t),
